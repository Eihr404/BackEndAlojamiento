...
{
    public class habitacionesRepository : RepositoryBase<habitaciones>, IhabitacionesRepository
    {
        public habitacionesRepository(AlojamientoDbContext context) : base(context) { }
    }
}
